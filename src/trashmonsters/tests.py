...
class TrashmonsterViewsetTest(APITestCase):
    ...
    def test_get_TM_player(self):
        ...
        response = self.client.post(
            self.url + "/monsters/get-tm", {"TM_ID": 1}, format="json"
        )
    ...
    def test_calcDistance_player(self):
        ...
        self.client.force_authenticate(self.user_player)
        response = self.client.post(
            self.url + "/monsters/calculate-distance",
    ...
    def test_verifyDistance_player(self):
        ...
        self.client.force_authenticate(self.user_player)
        response = self.client.post(
            self.url + "/monsters/verify-distance",
            {"TM_ID": 1, "o-lat": 2.0, "o-long": 11.0},
            format="json",
        )
    ...
    def test_changeScore_gamekeeper(self):
        ...
        self.client.force_authenticate(self.user_gk)
        response = self.client.post(
            self.url + "/monsters/change-score",
            {"TM_ID": 1, "T1Score": 1, "T2Score": 2, "T3Score": 4},
            format="json",
        )
    ...
    def test_addScore_gamekeeper(self):
        ...
        self.client.force_authenticate(self.user_gk)
        response = self.client.post(
            self.url + "/monsters/add-score",
            {"TM_ID": 1, "T1Score": 1, "T2Score": 1, "T3Score": 1},
            format="json",
        )
        content = json.loads(response.content.decode("utf-8"))
        self.assertEqual(content["Team1_Score"], 1)
    ...
    def test_removeScore_gamekeeper(self):
        ...
        self.client.post(
            self.url + "/monsters/change-score",
            {"TM_ID": 1, "T1Score": 9, "T2Score": 9, "T3Score": 9},
            format="json",
        )
        response = self.client.post(
            self.url + "/monsters/remove-score",
            {"TM_ID": 1, "T1Score": 1, "T2Score": 1, "T3Score": 0},
            format="json",
        )
        content = json.loads(response.content.decode("utf-8"))
    ...
    def test_getLeader_player(self):
        ...
        self.client.post(
            self.url + "/monsters/change-score",
            {"TM_ID": 1, "T1Score": 9, "T2Score": 8, "T3Score": 8},
            format="json",
        )
        self.client.force_authenticate(self.user_player)
        response = self.client.post(
            self.url + "/monsters/get-leader", {"TM_ID": 1}, format="json"
        )
